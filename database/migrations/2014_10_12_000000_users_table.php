...
class UsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('name', 100)->comment("field to store user's name, limit 25")->nullable();
            ...
            $table->string('avatar')->comment("field to store user's picture profile")->default('profile')->nullable();
